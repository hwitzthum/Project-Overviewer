...
const bundles = [
  ...
  },
  {
    ...
    files: ["js/api-client.js", "js/index-guard.js"],
  },
  {
  ...
  },
  {
    ...
    files: ["js/api-client.js", "js/theme.js", "js/login-page.js"],
  },
  {
    output: "register.bundle.js",
    files: ["js/api-client.js", "js/theme.js", "js/register-page.js"],
  },
];
const versionedCssFiles = ["css/theme.css", "css/app.css", "css/auth.css"];
...
async function main() {
  ...
  const cssHashes = versionedCssFiles.map((file) =>
    createContentHash(readSource(file)),
  );
  manifest.buildId = createContentHash(
    [...bundleHashes, ...cssHashes].join(":"),
  );
  fs.writeFileSync(
    manifestPath,
  ...
  process.stdout.write(
    `Built ${bundles.length} frontend bundles in ${path.relative(projectRoot, distDir)}\n`,
  );
}
