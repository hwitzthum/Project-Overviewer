...
🎯 **Kanban Board with WIP Limits** _(New)_
...
🔗 **Webhooks & Real-Time Collaboration** _(New)_
...
🔐 **Multi-User & Teams** _(with Enterprise-Grade Security)_
...
- ✅ Reset a teammate's password from the Admin Panel when they get locked out (signs them out of all sessions; they log in with the new password)
...
**Rate limit:** 5 imports per hour per IP address (prevents abuse)
